...
namespace FunWithMethods
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // C# 7 allows for parameters to be declared in the method call
            ...
            Console.WriteLine("Optional Arguments with named arguments");
            DisplayFancyMessage();
        ...
        // Method supporting optional arguments
